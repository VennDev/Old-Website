...
import {getTokenCookie, logout, removeTokenCookie, verifyToken} from "../components/server/server-helpers";
                ...
                <Dropdown.Menu
                    ...
                    <Dropdown.Item className="mt-3" bsPrefix=' ' as="div"  >
                        <div className="border-bottom px-3 pt-0 pb-3 d-flex justify-content-between align-items-end">
                            <span className="h4 mb-0">Notification</span>
                            <Link href="/" className="text-muted">
            ...
            <Dropdown as="li" className="ms-2">
                ...
                <Dropdown.Menu
                    ...
                    <Dropdown.Item as="div" className="px-4 pb-0 pt-2" bsPrefix=' '>
                            <div className="lh-1 ">
                                <h5 className="mb-1" id="user-name"></h5>
                    ...
                    {/*</Dropdown.Item>*/}
                    <Dropdown.Item>
                        <button onClick={logout}><i className="fe fe-power me-2"></i>Logout</button>
                    </Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
        </ListGroup>
